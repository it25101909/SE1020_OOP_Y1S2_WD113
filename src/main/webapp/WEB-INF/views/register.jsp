...
<head>
    ...
    <title>Passenger Registration | Zip SL</title>
    ...
    <style>
        ...
        .image-side {
            flex: 1;
            background: linear-gradient(135deg, rgba(249, 115, 22, 0.8), rgba(67, 56, 202, 0.8)), url('https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=1000') center/cover;
            display: flex;
        ...
        @media (max-width: 768px) {
            ...
            .image-side { padding: 30px; display: none; } /* Hide image on small screens for speed */
...
<body>
    ...
    <div class="split-container">
        <div class="image-side">
            <h2>Join Zip SL</h2>
            <p>Experience the ultimate ride hailing service. Fast, secure, and premium.</p>
        </div>
        ...
        <div class="form-side">
            ...
            <form action="${pageContext.request.contextPath}/register" method="post">
                ...
                <button type="submit">Register as Passenger</button>
            </form>

            <div class="footer">
                Want to drive for us? <a href="${pageContext.request.contextPath}/drivers/register">Apply Here</a><br><br>
